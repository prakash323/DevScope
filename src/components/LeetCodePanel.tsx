    ...
    <div className="space-y-6" id="leetcode-panel">
      ...
      {profile ? (
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-12 text-center shadow-sm">
          ...
          <h4 className="font-sans font-semibold text-gray-800 text-lg">No LeetCode Profile Connected</h4>
          <p className="text-sm text-gray-400 font-sans mt-1 max-w-sm mx-auto">
            Integrate your LeetCode profile to review your DSA problem statistics and generate compiler guidelines.
          </p>
        </div>
      )}
